...
class DeviceTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create device_type" do
    assert_difference('DeviceType.count') do
      post device_types_url, params: { device_type: { name: @device_type.name, protocol: @device_type.protocol } }
    end
  ...
  test "should update device_type" do
    patch device_type_url(@device_type), params: { device_type: { name: @device_type.name, protocol: @device_type.protocol } }
