...
class MaintainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create maintainer" do
    assert_difference('Maintainer.count') do
      post maintainers_url, params: { maintainer: { dni: @maintainer.dni, email: @maintainer.email, name: @maintainer.name, phone: @maintainer.phone } }
    end
  ...
  test "should update maintainer" do
    patch maintainer_url(@maintainer), params: { maintainer: { dni: @maintainer.dni, email: @maintainer.email, name: @maintainer.name, phone: @maintainer.phone } }
