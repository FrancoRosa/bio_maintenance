...
class AreasTest < ApplicationSystemTestCase
  ...
  test "creating a Area" do
    ...
    fill_in "Contact name", with: @area.contact_name
    fill_in "Contact phone", with: @area.contact_phone
    fill_in "Facility", with: @area.facility_id
    fill_in "Location", with: @area.location
